...
fun Month.displayText(short: Boolean = true): String {
    ...
    return getDisplayName(style, Locale.FRENCH)
}

fun DayOfWeek.displayText(uppercase: Boolean = false): String {
    return getDisplayName(TextStyle.SHORT, Locale.FRENCH).let { value ->
            if (uppercase) value.uppercase(Locale.FRENCH) else value
    }
}
